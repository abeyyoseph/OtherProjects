...
class RobotGazeboEnv(gym.Env):
    ...
    def resetCustom(self, goal_x, goal_y):
        print("Reset CUSTOM")
        rospy.logdebug("Reseting RobotGazeboEnvironment")
        self._reset_sim()
        print("Init env variable custom")
        self._init_env_variables_custom(goal_x, goal_y)
    ...
    def _reset_sim(self):
        ...
        if self.reset_controls :
            ...
            # print("unpausing sim")
            self.gazebo.unpauseSim()
            # print("first all systems check")
            self._check_all_systems_ready()
            # print("setting init pose")
            self._set_init_pose()
            # print("pausing sim")
            # self.gazebo.pauseSim()
            # print("resetting sim")
            ...
            # print("unpausing sim")
            # self.gazebo.unpauseSim()
            # print("second all systems check")
            # self._check_all_systems_ready()
            # print("pausing sim")
            self.gazebo.pauseSim()
